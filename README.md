...
Secondly chose a prefix for your discord bot. Make sure to make it unique so it doesn't mix up with other bots. I'd not use `?` or `!` as your prefix since these are common prefixes.
